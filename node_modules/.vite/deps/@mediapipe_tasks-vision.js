...
var B = class {
  constructor(t2, e2) {
    if (D(e2), this.g = t2, null != t2 && 0 === t2.length) throw Error("ByteString should be constructed with non-empty values");
  }
  h() {
    const t2 = N(this);
...
function pt(t2, e2) {
  if (0 == e2) return U();
  var n2 = ft(t2, e2);
  return t2.ca && t2.m ? n2 = t2.h.subarray(n2, n2 + e2) : (t2 = t2.h, n2 = n2 === (e2 = n2 + e2) ? C() : W ? t2.slice(n2, e2) : new Uint8Array(t2.subarray(n2, e2))), 0 == n2.length ? U() : new B(n2, O);
}
var gt = [];
function mt(t2) {
  var e2 = t2.g;
...
function Nt(t2, e2, n2, r2) {
  null != n2 && (e2 = It(t2, e2), r2(n2, t2), Dt(t2, e2));
}
var Bt = class {
...
var $t = Vt ? (t2) => 0 | t2[Vt] : (t2) => 0 | t2.g;
var qt = Vt ? (t2) => t2[Vt] : (t2) => t2.g;
var Jt = Vt ? (t2, e2) => (t2[Vt] = e2, t2) : (t2, e2) => (void 0 !== t2.g ? t2.g = e2 : Object.defineProperties(t2, { g: { value: e2, configurable: true, writable: true, enumerable: false } }), t2);
function Zt(t2) {
  return zt(t2, 34), t2;
}
function Qt(t2, e2) {
...
function ae(t2, e2, n2) {
  if (null != t2) {
    if ("string" == typeof t2) t2 = t2 ? new B(t2, O) : U();
    else if (t2.constructor !== B) if (M(t2)) t2 = t2.length ? new B(n2 ? t2 : new Uint8Array(t2), O) : U();
    else {
      if (!e2) throw Error();
      t2 = void 0;
    }
...
function Ne(t2) {
  switch (typeof t2) {
    ...
    case "number":
      return 0 < t2 ? void 0 : 0 === t2 ? Ue || (Ue = [0, void 0]) : [-t2, void 0];
    case "string":
      return [0, t2];
    case "object":
      return t2;
...
function rn(t2, e2, n2 = te) {
  if (null != t2) {
    ...
    if (Array.isArray(t2)) {
      var r2 = $t(t2);
      return 2 & r2 ? t2 : (e2 && (e2 = 0 === r2 || !!(32 & r2) && !(64 & r2 || !(16 & r2))), e2 ? Jt(t2, -12293 & (34 | r2)) : tn(t2, rn, 4 & r2 ? te : n2, true, true));
    }
...
function yn(t2, e2, n2) {
  ...
  return En(a2) || (n2 = a2, (a2 = (t2 = 1 === s2 || 4 === s2 && !!(32 & a2)) ? Yt(a2, 2, true) : Dn(a2, i2, false)) !== n2 && Jt(o2, a2), t2 && Object.freeze(o2)), 2 === s2 && En(a2) && (o2 = Gt(o2), a2 = Dn(a2 = In(a2, i2), i2, false), Jt(o2, a2), fn(r2, i2, e2, o2)), o2;
}
...
function Tn(t2, e2, n2) {
  {
    ...
    if (ue(h2), null == n2) fn(a2, h2, e2);
      ...
      if ((r2 = !o2) && (r2 = false), hn(t2, i2)) for (i2 = 21, o2 && (n2 = Gt(n2), s2 = 0, i2 = Dn(i2 = In(i2, h2), h2, true)), t2 = 0; t2 < n2.length; t2++) n2[t2] = Re(n2[t2]);
      r2 && (n2 = Gt(n2), s2 = 0, i2 = Dn(i2 = In(i2, h2), h2, true)), i2 !== s2 && Jt(n2, i2), fn(a2, h2, e2, n2);
    }
  }
}
...
function Mn(t2, e2, n2, r2, i2, s2) {
  ...
  return En(h2) || (n2 = h2, (h2 = (s2 = 1 === o2 || 4 === o2 && !!(32 & h2)) ? Yt(h2, !a2.length || 16 & h2 && (!c2 || 32 & h2) ? 2 : 2048, true) : Dn(h2, e2, i2)) !== n2 && Jt(a2, h2), s2 && Object.freeze(a2)), 2 === o2 && En(h2) && (a2 = Gt(a2), h2 = Dn(h2 = In(h2, e2), e2, i2), Jt(a2, h2), fn(t2, e2, r2, a2)), a2;
}
...
function rr(t2, e2, n2) {
  ...
  i2 && i2 === De ? (t2.g || (t2.g = /* @__PURE__ */ new Set())).add(e2) : n2[0] && (t2.h || (t2.h = /* @__PURE__ */ new Set())).add(e2);
}
function ir(t2, e2) {
...
function sr(t2) {
  ...
  if (!(e2 = ar(t2, t2[nr] = new Qn(), ir, ir, rr)).ea && !e2.h && !e2.g) {
    ...
    n2 ? (Ne(t2[0]) === De ? er ? e2 = er : ((e2 = new Qn()).T = Ne(true), e2 = er = e2) : e2 = tr || (tr = new Qn()), e2 = t2[nr] = e2) : e2.j = true;
  }
  return e2;
}
...
var jr = wr(function(t2, e2, n2) {
  return 0 === t2.h && (br(e2, n2, ot(t2.g)), true);
}, Sr);
var Vr = Tr(function(t2, e2, n2) {
...
var Zr = wr(function(t2, e2, n2) {
  return 2 === t2.h && (br(e2, n2, Et(t2)), true);
}, Mr);
var Qr = Tr(function(t2, e2, n2) {
...
var ai = [0, Kr, wr(function(t2, e2, n2) {
  return 2 === t2.h && (br(e2, n2, (t2 = Et(t2)) === U() ? void 0 : t2), true);
}, function(t2, e2, n2) {
  if (null != e2) {
    if (e2 instanceof zn) {
      const r2 = e2.Qa;
      return void (r2 && (e2 = r2(e2), null != e2 && Ut(t2, n2, X(e2).buffer)));
    }
...
var _i = {};
var vi = [-2, _i, Hr];
_i[336783863] = [0, Yr, Hr, -1, jr, [0, [1, 2, 3, 4, 5, 6], Jr, gi, Jr, di, Jr, fi, Jr, mi, Jr, ci, Jr, [0, Yr]], hi, Hr, [0, [1, 3], [2, 4], Jr, [0, Vr], -1, Jr, [0, zr], -1], Yr];
var Ei = [0, Kr, Wr];
...
es.B = [1, 2, 3, 8, 9];
var ns = ii(es, [0, zr, Vr, Ur, ts, Yr, -1, Nr, Cr, zi, zr, Nr]);
...
var ws = [1, 2];
var Ts = [0, ws, Jr, [0, Ur], Jr, [0, Zr], jr, Yr];
var As = class extends zn {
  constructor(t2) {
    super(t2);
  }
...
yo.prototype.g = si([0, Os, ro, lo, Ds, Xs, po, mo]);
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (function(t3, e4) {
        ...
        this.g.i.FS_createDataFile("/", "model.dat", new Uint8Array(t3), true, false, false), Qo(this, "/model.dat"), this.m(), this.M();
      });
      Qo(this, e3.modelAssetBuffer);
    }
    return this.m(), this.M(), Promise.resolve();
  }
  M() {
  }
  fa() {
...
var Na = class {
  ...
  xa(t2, e2, n2 = [0, 0, 0, 255]) {
    ...
    }(this, t2, n2, e2) : Da(this, t2.O(), n2, e2);
  }
  ya(t2, e2, n2) {
    this.l ? function(t3, e3, n3, r2) {
      const i2 = Oa(t3);
    ...
    }(this, t2, e2, n2) : Ua(this, t2.O(), e2, n2);
  }
  close() {
    var _a2, _b, _c;
...
function rh(t2, e2, n2, r2) {
  ...
  return t2 = new Sa([i2], n2, false, t2.g.i.canvas, t2.L, s2, e2), r2 ? t2.clone() : t2;
}
var ih = class extends sa {
  constructor(t2, e2, n2, r2) {
    super(t2), this.g = t2, this.ba = e2, this.V = n2, this.ra = r2, this.L = new ga();
  }
  l(t2, e2 = true) {
...
var sh = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "image_in"), Ii(t2, "norm_rect_in"), Di(t2, "detections");
    const e2 = new yi();
    Wn(e2, Us, this.h);
    const n2 = new Li();
...
var yh = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "image_in"), Ii(t2, "norm_rect"), Di(t2, "face_landmarks");
    const e2 = new yi();
    Wn(e2, zs, this.h);
    const n2 = new Li();
    ki(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      ...
      ea(this, t3);
    }), this.outputFaceBlendshapes && (Di(t2, "blendshapes"), Si(n2, "BLENDSHAPES:blendshapes"), this.g.attachProtoVectorListener("blendshapes", (t3, e3) => {
      ...
      ea(this, t3);
    })), this.outputFacialTransformationMatrixes && (Di(t2, "face_geometry"), Si(n2, "FACE_GEOMETRY:face_geometry"), this.g.attachProtoVectorListener("face_geometry", (t3, e3) => {
...
var _h = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "image_in"), Ii(t2, "norm_rect"), Di(t2, "stylized_image");
    const e2 = new yi();
    Wn(e2, Ys, this.j);
    const n2 = new Li();
    ki(n2, "mediapipe.tasks.vision.face_stylizer.FaceStylizerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "STYLIZED_IMAGE:stylized_image"), n2.o(e2), Oi(t2, n2), this.g.W("stylized_image", (t3, e3) => {
      ...
      i2 = new Ka([r2], false, false, this.g.i.canvas, this.L, i2, t3), this.u = n3 = n3 ? i2.clone() : i2, this.h && this.h(n3), ea(this, e3);
...
var Ah = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "image_in"), Ii(t2, "norm_rect"), Di(t2, "hand_gestures"), Di(t2, "hand_landmarks"), Di(t2, "world_hand_landmarks"), Di(t2, "handedness");
    const e2 = new yi();
    Wn(e2, co, this.v);
    const n2 = new Li();
...
var kh = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "image_in"), Ii(t2, "norm_rect"), Di(t2, "hand_landmarks"), Di(t2, "world_hand_landmarks"), Di(t2, "handedness");
    const e2 = new yi();
    Wn(e2, ho, this.j);
    const n2 = new Li();
    ki(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "LANDMARKS:hand_landmarks"), Si(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Si(n2, "HANDEDNESS:handedness"), n2.o(e2), Oi(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) t3 = os(e4), this.worldLandmarks.push(Do(t3));
      ea(this, e3);
    }), this.g.attachEmptyPacketListener("world_hand_landmarks", (t3) => {
      ea(this, t3);
    }), this.g.attachProtoVectorListener("handedness", (t3, e3) => {
...
var Rh = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "input_frames_image"), Di(t2, "pose_landmarks"), Di(t2, "pose_world_landmarks"), Di(t2, "face_landmarks"), Di(t2, "left_hand_landmarks"), Di(t2, "left_hand_world_landmarks"), Di(t2, "right_hand_landmarks"), Di(t2, "right_hand_world_landmarks");
    ...
    ki(r2, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"), Un(r2, 8, oi, n2), xi(r2, "IMAGE:input_frames_image"), Si(r2, "POSE_LANDMARKS:pose_landmarks"), Si(r2, "POSE_WORLD_LANDMARKS:pose_world_landmarks"), Si(r2, "FACE_LANDMARKS:face_landmarks"), Si(r2, "LEFT_HAND_LANDMARKS:left_hand_landmarks"), Si(r2, "LEFT_HAND_WORLD_LANDMARKS:left_hand_world_landmarks"), Si(r2, "RIGHT_HAND_LANDMARKS:right_hand_landmarks"), Si(r2, "RIGHT_HAND_WORLD_LANDMARKS:right_hand_world_landmarks"), r2.o(e2), Oi(t2, r2), na(this, t2), this.g.attachProtoListener("pose_landmarks", (t3, e3) => {
      ...
      t3 = os(t3), n3.push(Do(t3)), ea(this, e3);
      ...
      ea(this, t3);
    }), this.outputFaceBlendshapes && (Di(t2, "extra_blendshapes"), Si(r2, "FACE_BLENDSHAPES:extra_blendshapes"), this.g.attachProtoListener("extra_blendshapes", (t3, e3) => {
...
var Mh = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "input_image"), Ii(t2, "norm_rect"), Di(t2, "classifications");
    const e2 = new yi();
    Wn(e2, vo, this.h);
    const n2 = new Li();
...
var Ph = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "image_in"), Ii(t2, "norm_rect"), Di(t2, "embeddings_out");
    const e2 = new yi();
    Wn(e2, wo, this.h);
    const n2 = new Li();
...
Ph.cosineSimilarity = function(t2, e2) {
  if (t2.floatEmbedding && e2.floatEmbedding) t2 = No(t2.floatEmbedding, e2.floatEmbedding);
    ...
    t2 = No(Uo(t2.quantizedEmbedding), Uo(e2.quantizedEmbedding));
  }
  return t2;
...
var Dh = class extends ih {
  ...
  m() {
    ...
    Wn(e2, So, this.h);
    const n2 = new Li();
    ki(n2, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"), xi(n2, "IMAGE:image_in"), xi(n2, "NORM_RECT:norm_rect"), n2.o(e2), Oi(t2, n2), na(this, t2), this.outputConfidenceMasks && (Di(t2, "confidence_masks"), Si(n2, "CONFIDENCE_MASKS:confidence_masks"), ra(this, "confidence_masks"), this.g.da("confidence_masks", (t3, e3) => {
    ...
    })), this.outputCategoryMask && (Di(t2, "category_mask"), Si(n2, "CATEGORY_MASK:category_mask"), ra(this, "category_mask"), this.g.W("category_mask", (t3, e3) => {
    ...
    })), Di(t2, "quality_scores"), Si(n2, "QUALITY_SCORES:quality_scores"), this.g.attachFloatVectorListener("quality_scores", (t3, e3) => {
...
Dh.prototype.getLabels = Dh.prototype.Fa, Dh.prototype.segmentForVideo = Dh.prototype.Na, Dh.prototype.segment = Dh.prototype.ga, Dh.prototype.setOptions = Dh.prototype.o, Dh.createFromModelPath = function(t2, e2) {
  return Qa(Dh, t2, { baseOptions: { modelAssetPath: e2 } });
}, Dh.createFromModelBuffer = function(t2, e2) {
  return Qa(Dh, t2, { baseOptions: { modelAssetBuffer: e2 } });
}, Dh.createFromOptions = function(t2, e2) {
  return Qa(Dh, t2, e2);
};
var Uh = class {
  constructor(t2, e2, n2) {
...
Uh.prototype.close = Uh.prototype.close;
...
var rc = class extends ih {
  ...
  ga(t2, e2, n2, r2) {
    ...
    if (e2.keypoint) {
      ...
      for (a2 of (o2 = new Jh(), e2.scribble)) Vn(e2 = new $h(), 3, true), Hn(e2, 1, a2.x), Hn(e2, 2, a2.y), Un(o2, 1, $h, e2);
      On(s2, 15, Qh, o2);
    }
    Un(r2, 1, Zh, s2), this.g.addProtoToStream(r2.g(), "drishti.RenderData", "roi_in", n2), eh(this, t2, i2);
    t: {
      try {
        const t3 = new Uh(this.confidenceMasks, this.categoryMask, this.qualityScores);
        if (!this.j) {
          var h2 = t3;
          break t;
        }
...
var ic = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "input_frame_gpu"), Ii(t2, "norm_rect"), Di(t2, "detections");
    const e2 = new yi();
    Wn(e2, Fo, this.h);
    const n2 = new Li();
...
var hc = class extends ih {
  ...
  m() {
    var t2 = new Ui();
    Ii(t2, "image_in"), Ii(t2, "norm_rect"), Di(t2, "normalized_landmarks"), Di(t2, "world_landmarks"), Di(t2, "segmentation_masks");
    const e2 = new yi();
    Wn(e2, Mo, this.h);
    const n2 = new Li();
...
export {
  ...
  Ph as ImageEmbedder,
  Dh as ImageSegmenter,
  Ch as ImageSegmenterResult,
  rc as InteractiveSegmenter,
  Uh as InteractiveSegmenterResult,
  Ka as MPImage,
  Sa as MPMask,
